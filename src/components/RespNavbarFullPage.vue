    ...
    <nav :class="['navbar', { 'scrolled': isScrolled }]" class="navbar-expand-lg">
      <div class="container">
        ...
        <div class="navItemsContainer">
          ...
          <button class="hamburger-button" :class="{ 'active': isMobileMenuOpen }" @click="toggleMobileMenu"
          ...
          <div class="collapse navbar-collapse" :class="{ 'show': isMobileMenuOpen }" id="navbarTogglerDemo02">
            ...
            <nav class="donatebtn">
              <a href="https://www.jedonneenligne.org/fdets/campagne/ets/challenges/view/57020bb8-de75-11ef-a492-0050560131d0"
                target="_blank" class="btn btn-danger" role="button" @click="closeMobileMenu">
                {{ $t('donateBtn') }}
              </a>
            </nav>
          </div>
